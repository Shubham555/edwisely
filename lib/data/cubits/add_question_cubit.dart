          ...
          data: FormData.fromMap(
            {
              ...
              'option1': option1 == null ? null : MultipartFile.fromBytes(option1.toUint8List(), filename: option1.fileName),
              'option2': option2 == null ? null : MultipartFile.fromBytes(option2.toUint8List(), filename: option2.fileName),
              'option3': option3 == null ? null : MultipartFile.fromBytes(option3.toUint8List(), filename: option3.fileName),
              'option4': option4 == null ? null : MultipartFile.fromBytes(option4.toUint8List(), filename: option4.fileName),
              'option5': option5 == null ? null : MultipartFile.fromBytes(option5.toUint8List(), filename: option5.fileName),
              'hint': hint,
              'solution': solution
            },
          ),
