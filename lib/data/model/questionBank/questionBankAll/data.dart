...
class Data {
  ...
  Data.fromJsonMap(Map<String, dynamic> map)
      : objective_questions = List<Objective_questions>.from(
            map["objective_questions"]
                .map((it) => Objective_questions.fromJsonMap(it))),
        subjective_questions = List<Subjective_questions>.from(
            map["subjective_questions"]
                .map((it) => Subjective_questions.fromJsonMap(it)));
