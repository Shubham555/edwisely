  ...
  LoginEntity.fromJsonMap(Map<String, dynamic> map)
      : college_id = map["college_id"],
        college_university_degree_department_id =
            map["college_university_degree_department_id"],
        ...
        university_degree_department_id =
            map["university_degree_department_id"],
        user_id = map["user_id"];

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['college_id'] = college_id;
    data['college_university_degree_department_id'] =
        college_university_degree_department_id;
